...
Public Class updateform
    ...
    Public Sub DownloadComplete(ByVal cancelled As Boolean)
        ...
        Else
            ...
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\SOFTWARE\Content-Reader", "ulevel", "1")
            Process.Start(Application.StartupPath + "\update\Content Reader.exe")
    ...
    Public Sub ChangeTexts(ByVal length As Long, ByVal position As Integer, ByVal percent As Integer, ByVal speed As Double)
        Try
            ...
            Me.Label5.Text = "Downloading: " & "https://github.com/bssam1996/Content-Reader/raw/master/EXE%20File/Content reader.exe"
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            Try
                theRequest = WebRequest.Create("https://raw.githubusercontent.com/bssam1996/Content-Reader/master/EXE%20file/Content%20Reader.exe")
            ...
            Dim writeStream As New IO.FileStream(Me.whereToSave + "\Content Reader.exe", IO.FileMode.Create)
